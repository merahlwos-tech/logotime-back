...
router.get('/images', authenticateAdmin, async (req, res) => {
  try {
    const MANAGED = [
      ...
      { key: 'boite',     path: 'public/boite.webp',      label: 'Catégorie Boites (mobile)' },
      { key: 'boitePC',   path: 'public/boitePC.webp',    label: 'Catégorie Boites (desktop)' },
      ...
      { key: 'carte',     path: 'public/carte.webp',      label: 'Catégorie Cartes (mobile)' },
      { key: 'cartePC',   path: 'public/cartePC.webp',    label: 'Catégorie Cartes (desktop)' },
      { key: 'papier',    path: 'public/papier.webp',     label: 'Catégorie Papier (mobile)' },
      { key: 'papierPC',  path: 'public/papierPC.webp',   label: 'Catégorie Papier (desktop)' },
